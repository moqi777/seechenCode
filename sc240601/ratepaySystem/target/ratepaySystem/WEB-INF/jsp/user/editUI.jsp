...
<form id="form" name="form" action="${basePath}nsfw/user_edit.action" method="post" enctype="multipart/form-data">
    ...
    <table id="baseInfo" width="100%" align="center" class="list" border="0" cellpadding="0" cellspacing="0"  >
        ...
        <tr>
            ...
            <td><s:textfield id="birthday" name="user.birthday" onfocus="WdatePicker({skin:'whyGreen',dateFmt: 'yyyy-MM-dd HH:mm:ss'})">
            	<s:param name="value">
                <s:date name="user.birthday" format="yyyy-MM-dd HH:mm:ss"/>
                 </s:param>
            	</s:textfield></td>
        </tr>
		<tr>
