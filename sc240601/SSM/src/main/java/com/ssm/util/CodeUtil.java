 ...
 * 描述:
 *  验证码生成工具类
 *  调用processRequest方法传入req和resp即可
 *  会自动传输验证图片到前端
 *  并将验证码的值存在session  "randomCode"中
 *  前端：<img src="/admin/getCode" style="cursor: pointer;" onclick="this.src=this.src+'?d='+Math.random();" title="点击刷新">
 * @author bigpeng
